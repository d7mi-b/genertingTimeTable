import { faEdit, faTrash, faUser, faLock, faXmark } from '@fortawesome/free-solid-svg-icons';
...
const Users = () => {
    ...
    return (
        <section className={`containerPage ${style.users}`}>
            <header>
                <h1>المستخدمين</h1>
                <button className={`btn btnAddUsers ${style.btn}`}>إضافة مستخدمين</button>
            </header>
            ...
            <section className={`container-section ${style.addUsersSection}`}>
                <article className={`center-section`}>
                    ...
                    <form onSubmit={handelSubmit} className={`addForm ${style.addUsersForm}`}>
                        ...
                        <section className='btnContainer'>
                            <input className={`btn ${style.btn}`} type='submit' name='submit' value='إضافة مستخدم' />
                        </section>
                    </form>
                </article>
            </section>
