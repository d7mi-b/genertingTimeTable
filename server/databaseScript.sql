...
VALUES (
    ...
    (25, 'وضاح السبتي', 1, '', 0, 1, 1, 1, 1, 1, 1),
...
VALUES (1, 1, 1, 17, 1, 3, 1, 1, 1),
    ...
    (12, 3, 16, 3, 1, 3, 2, 1, 1),
    (13, 3, 20, 1, 1, 3, 2, 1, 1),
    (14, 3, 20, 26, 1, 8, 2, 2, 3),
    (15, 3, 18, 25, 1, 1, 2, 2, 3),
    (16, 3, 16, 34, 1, 1, 2, 2, 3),
    (17, 3, 15, 24, 1, 3, 2, 1, 1),
    (18, 3, 15, 24, 1, 3, 2, 1, 1),
    (19, 3, 19, 17, 1, 3, 2, 1, 1),
    (20, 3, 18, 16, 1, 3, 2, 1, 1),
    (21, 3, 17, 20, 1, 3, 2, 1, 1),
    (22, 5, 28, 8, 1, 3, 3, 1, 1),
    (23, 5, 28, 26, 1, 8, 3, 2, 3),
    (24, 5, 32, 5, 1, 3, 3, 1, 1),
    (25, 5, 29, 2, 1, 3, 3, 1, 1),
    (26, 5, 31, 1, 1, 3, 3, 1, 1),
    (27, 5, 32, 28, 1, 10, 3, 2, 3),
    (28, 5, 31, 28, 1, 11,3, 2, 3),
    (29, 5, 30, 7, 1, 3, 3, 1, 1),
    (30, 5, 27, 36, 1, 3, 3, 1, 1),
    (31, 5, 29, 29, 1, 1, 3, 2, 3),
    (32, 5, 30, 31, 1, 6, 3, 2, 3),
    (33, 5, 27, 36, 1, 3, 3, 3, 1),
    (34, 7, 43, 5, 1, 3, 4, 1, 1),
    (35, 7, 41, 2, 1, 3, 4, 1, 1),
    (36, 7, 39, 25, 1, 3, 4, 1, 1),
    (37, 7, 42, 32, 1, 2, 4, 2, 3),
    (38, 7, 43, 29, 1, 1, 4, 2, 3),
    (39, 7, 41, 34, 1, 1, 4, 2, 3),
    (40, 7, 40, 1, 1, 3, 4, 1, 1),
    (41, 7, 44, 25, 1, 3, 4, 1, 1),
    (42, 7, 44, 25, 1, 1, 4, 2, 3),
    (43, 7, 42, 4, 1, 3, 4, 1, 1),
    (44, 9, 52, 1, 1, 3, 5, 1, 1),
    (45, 9, 53, 4, 1, 3, 5, 1, 1),
    (46, 9, 54, 16, 1, 3, 5, 1, 1),
    (47, 9, 52, 21, 1, 1, 5, 2, 2),
    (48, 9, 53, 32, 1, 1, 5, 2, 2),
    (49, 9, 54, 21, 1, 1, 5, 2, 2);
...
CREATE TABLE lecturer_requsets (
    ...
    SET NULL,
        FOREIGN KEY (Module_ID) REFERENCES module (Module_ID) ON DELETE
    SET NULL,
