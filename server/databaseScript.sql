...
VALUES (1, 'Defferential Calculus', 'MATH111', 2, 0, 2, 1, 1),
    ...
    (3, 'General Chemistry I', 'CHEM111', 1, 2, 0, 1, 1),
    ...
    (19, 'Differential Equations', 'DIFEQ', 2, 0, 2, 1, 4),
    (20, 'User Interface Development', 'UID', 2, 2, 0, 1, 4),
    (21, 'Microprocessor', 'MPU11', 2, 2, 0, 1, 6),
    (22, 'Numerical Method', 'NM121', 4, 0, 0, 1, 6),
    (23, 'Computer Archtrcture', 'COARC121', 2, 2, 0, 1, 6),
    (24, 'Digital Electornics', 'DELE131', 2, 2, 0, 1, 6),
    (25, 'Software Engineering', 'SWENG', 2, 2, 0, 1, 6),
    (26, 'Communication Skills', 'COSKL11', 2, 0, 0, 1, 6),
    (27, 'Computer Network II', 'CN131', 3, 2, 0, 1, 8),
    (28, 'Artificial Intelligence', 'CSAI', 2, 2, 0, 1, 8),
    (29, 'VLSI Cicuite Design', 'CEVLSI', 2, 2, 0, 1, 8),
    (30, 'Data Security', 'CSDSEC', 2, 2, 0, 1, 8),
    (31, 'Real-Time Computer Control & PLC', 'ECEPLC', 2, 2, 0, 1, 8),
    (32, 'Parrallel Processing Techniques', 'CEPPT', 2, 0, 0, 1, 10),
    (33, 'Neural Network', 'CSNN', 2, 2, 0, 1, 10);
...
VALUES (1, 'خالد فوزي اشبير', 1, 'doctor', 0, 3, 1, 0, 1, 1, 0),
    ...
    (3, 'سهام بامطرف', 1, 'doctor', 0, 1, 0, 1, 0, 0, 0),
    (4, 'مكارم بامطرف', 1, 'doctor', 0, 2, 0, 1, 0, 1, 0),
    (5, 'مازن باحشوان', 1, 'doctor', 0, 1, 1, 0, 0, 0, 0),
    (6, 'مجدي مرعي', 2, 'doctor', 0, 2, 0, 1, 0, 0, 0),
    (7, 'خالد بن سحاق', 2, 'doctor', 0, 1, 0, 0, 0, 0, 0),
    (8, 'هشام باكرمان', 2, 'doctor', 0, 2, 0, 0, 0, 0, 0),
    (9, 'وداد محمود فيصل', 2, 'doctor', 0, 3, 1, 0, 0, 0, 0),
    ...
    (17, 'فاطمة بابقي', 7, '', 1, 4, 1, 0, 0, 0, 1),
    (18, 'أمين', 7, '', 0, 2, 1, 0, 0, 0, 0),
    (19, 'إيمان', 7, '', 0, 2, 0, 1, 0, 1, 0),
    (20, 'نايف بن همام', 7, '', 0, 2, 0, 1, 0, 0, 0),
    (21, 'ناصر الغيثي', 1, '', 0, 3, 0, 0, 1, 0, 1),
    (22, 'صالح بارفعه', 7, '', 0, 3, 0, 0, 1, 0, 0),
    (23, 'عمرو عبدالرب', 7, '', 0, 2, 0, 0, 0, 0, 1),
    (24, 'خالد بازهير', 7, '', 0, 3, 0, 0, 1, 0, 0),
    (25, 'وضاح السبتي', 1, '', 0, 1, 0, 0, 0, 1, 0),
    (26, 'خالد بن صديق', 2, '', 0, 3, 0, 0, 0, 0, 1),
    (27, 'محمد بافقيه', 7, '', 0, 3, 1, 0, 0, 0, 0),
    (28, 'وفاء ادريس', 1, '', 0, 3, 0, 1, 1, 0, 0),
    (29, 'عصمت', 1, '', 0, 3, 1, 1, 0, 0, 1),
    (30, 'عبدالله باحسن', 2, 'doctor', 0, 3, 0, 0, 1, 0, 0),
    (31, 'امل بن عيدان', 2, '', 0, 3, 0, 0, 0, 0, 1),
    (32, 'فاطمة بافرج', 1, '', 0, 3, 1, 0, 1, 0, 0),
    (33, 'علاء باسواقي', 2, '', 0, 2, 0, 0, 0, 0, 1),
    (34, 'صفاء جوهر', 1, '', 0, 3, 0, 0, 1, 0, 0);
...
Create table E_T_T(
    ...
    foreign key(Time_ID) references time(Time_ID) ON DELETE SET NULL,
